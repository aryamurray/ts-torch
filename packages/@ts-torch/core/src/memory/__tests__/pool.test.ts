...
describe('TensorPool', () => {
  ...
  describe('Real-world scenarios', () => {
    test('training loop pattern', () => {
      ...
      for (let i = 0; i < 100; i++) {
        const tensor = pool.acquire([256, 256], 'float32') ?? new MockPoolableTensor([256, 256], 'float32')
    ...
    test('mixed shapes and dtypes', () => {
      ...
      const dtypes: Array<'float32' | 'float64'> = ['float32', 'float32', 'float64', 'float32', 'float64']
