...
export function binaryCrossEntropyLoss<S extends Shape, D extends DType<string>>(
  ...
  if (
    ...
    const logOneMinusInput =
      'log' in oneMinusInputPlus1 && typeof (oneMinusInputPlus1 as { log?: Function }).log === 'function'
    ...
    bce = 'mul' in sum && typeof (sum as { mul?: Function }).mul === 'function' ? ((sum.mul as any)(-1) as Tensor) : sum
  } else {
